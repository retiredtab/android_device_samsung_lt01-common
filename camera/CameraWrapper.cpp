...
char * camera_fixup_setparams(int id, const char * settings)
{
    ...
    if (params.get("iso")) {
        const char *iso = params.get(android::CameraParameters::KEY_ISO);
        if (strcmp(iso, "ISO100") == 0)
            params.set(android::CameraParameters::KEY_ISO, "100");
        else if (strcmp(iso, "ISO200") == 0)
            params.set(android::CameraParameters::KEY_ISO, "200");
        else if (strcmp(iso, "ISO400") == 0)
            params.set(android::CameraParameters::KEY_ISO, "400");
        else if (strcmp(iso, "ISO50") == 0)
            params.set(android::CameraParameters::KEY_ISO, "50");
    }
